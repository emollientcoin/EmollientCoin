...
money_t GetProofOfStakeReward(timestamp_t coinAge, blockheight_t prevHeight)
{
	...
	money_t rewardCoinYear = COIN * 800 / 10000; //  08% per year
	if (prevHeight <= 43836 * 12)
		rewardCoinYear = COIN * 3600 / 10000; // 36% per year
	else if (prevHeight <= 43836 * 24)
		rewardCoinYear = COIN * 2400 / 10000; // 24% per year
	else if (prevHeight <= 43836 * 36)
		rewardCoinYear = COIN * 1800 / 10000; // 18% per year
	else if (prevHeight <= 43836 * 48)
		rewardCoinYear = COIN * 1200 / 10000; // 12% per year
